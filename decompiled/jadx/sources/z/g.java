...
public final class g implements u1.d {
    ...
    public static final g f3094a = new Object();
    ...
    static {
        ...
        b = new u1.c("startMs", Collections.unmodifiableMap(new HashMap(hashMap)));
        x1.a aVar2 = new x1.a(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(x1.d.class, aVar2);
        c = new u1.c("endMs", Collections.unmodifiableMap(new HashMap(hashMap2)));
    }
